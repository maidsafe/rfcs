...
find D. All members of S then send the nodes age incremented (++R) to D with the nodes current
PublicKey (Id).
...
group size or similar. It is proposed in this RFC the quorum is set at >= 50% of the group.
